...
export const Navbar = ({ navLinks = navData }) => {
  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 dark:border-gray-800 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="/">
              <span className="sr-only">WesterosCraft</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 593.39 81.56"
                className="h-6 w-auto sm:h-7 fill-current text-black dark:text-gray-50">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            {process.browser && (
              <div className="ml-2" suppressHydrationWarning={true}>
                <DarkModeToggle />
              </div>
            )}
          </nav>
        ...
        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          <div className="pt-5 pb-6 px-5">
            <div className="flex items-center justify-between">
              <div>
                <img className="h-5 w-auto" src="/westeroscraft_logo.svg" alt="WesterosCraft" />
              </div>
              <div className="-mr-2">
                <button
                  onClick={toggleMobileNav}
