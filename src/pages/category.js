        ...
        >
          {data.craft.entries.map((entry, i) => (
            ...
            >
              {(close) => (
                <Flex
                  sx={{ position: 'relative', border: '2px solid black', overflowWrap: 'break-word' }}
                  flexDirection="column"
                  alignItems="center"
                ...
                >
                  ...
                  >
                    {entry.textures.length &&
                      entry.textures.map((img, i) => (
                        <Flex flexDirection="column" className="texture" alignItems="center" key={i}>
                  ...
                  <Flex
                    ...
                    maxWidth={768}
                  >
                    <Flex as="ol" flexDirection="column" width={[1, null, null, '50%']} sx={{ paddingInlineStart: 0 }}>
